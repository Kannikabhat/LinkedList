...
// // 👇 Generic so it works with any type of LessonStep (Hashing, Linked List, etc.)
// interface ContentStepProps<TStep extends { title: string; content?: string; chatbot?: any[] }> {
//   step: TStep;
// }

// export default function ContentStep<TStep extends { title: string; content?: string; chatbot?: any[] }>({
//   step,
// }: ContentStepProps<TStep>) {
...
//           answer: answers[idx] || "",
//           attempt: nextAttempt,
//           context: `Lesson: ${step.title}. ${
//             questionObj?.hint ? `Hint provided: ${questionObj.hint}` : ""
//           }`,
//         }),
//       });
...
//             ),
//             ul: ({ children }) => (
//               <ul className="space-y-2 mb-6 bg-gradient-to-br from-pink-50 to-blue-50 p-4 rounded-lg">
//                 {children}
//               </ul>
//             ),
//             li: ({ children }) => (
