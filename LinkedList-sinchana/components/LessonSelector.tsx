...
interface LessonSelectorProps {
  ...
  topic: string; // "Linked Lists" | "Hashing" etc.
  onLessonSelect: (lessonId: number) => void;
}

export default function LessonSelector({ lessons, topic, onLessonSelect }: LessonSelectorProps) {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Master {topic.toLowerCase()} through interactive visualizations, step-by-step explanations, 
        ...
        <div className="text-center mt-12 text-gray-500">
          <p className="text-lg">
            Ready to master {topic.toLowerCase()}? Choose a lesson above to begin your journey!
          </p>
        </div>
      </div>
    </div>
