...
export const lessons: Lesson[] = [
  {
    ...
    steps: [
      ...
      "id": "linkedlist-qna-1",
      "type": "content",
      "title": "❓ Why Not Just Arrays?",
      "content": "We already know arrays are useful for storing multiple elements together. But let's think deeper — are arrays always the best?",
      "chatbot": [
        {
    ...
    {
      "id": "linkedlist-scenario-1",
      "type": "content",
      "title": "🟢 Scenario – Train Coaches 🚆",
      "content": "Imagine a train where each coach is connected to the **next coach**. If the railway wants to add or remove a coach, they can just attach or detach it without disturbing the whole train.\n\n**Question to User:**\nIf you were to represent this in a program, how would you store these coaches so that:\n- Each coach just knows the **next coach**,\n- Adding/removing a coach doesn’t need shifting all the others?",
      "chatbot": [
        {
          "question": "If each coach only knows about the next one, how would you design this structure?",
          "context": "Think of each coach as a node that stores data and a pointer to the next coach.",
          "hint": "This structure sounds like a linked list.",
          "topic": "linked list"
        }
      ]
    },
