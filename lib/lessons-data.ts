...
export const lessons: Lesson[] = [
  {
    ...
    steps: [
      {
        id: "singly-chatbot-why",
        type: "content",
        title: "Why Do We Need Singly Linked Lists?",
        content: `Arrays are useful, but they have limitations such as fixed size and costly insertions/deletions. Singly linked lists solve some of these problems by allowing dynamic memory allocation and efficient insertions/deletions.`,
...
\`\`\``
      ,chatbot: [
          {
            question: "You're implementing a printer queue using an array. Think about what happens when 20 students all send print jobs at once, but your array can only hold 10 jobs. What problems might you face, and what would an ideal solution look like?",
            context: "Arrays have a fixed size that you must declare upfront. Consider what happens when you need more space than expected, or when you're wasting space during quiet periods. Also think about what happens when jobs are completed and removed from the front of the queue.",
            hint: "Think about memory allocation, size limitations, and what 'dynamic' means in data structures"
          }
        ]},
      {
        id: "singly-2",
